...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private void createTableStorage(SQLiteDatabase db) {
        Log.i(TAG, "Creating storage table");
    ...
    // Storage
    public void insertStorage(String time, String app, String version, String protocol, String dIP, String dPort) {
        ...
        try {
            ...
            try {
                ...
                if (db.insert("storage", null, cv) == -1)
    ...
    public void deleteStorage(String time) {
        mLock.writeLock().lock();
        try {
            SQLiteDatabase db = this.getWritableDatabase();
            db.beginTransactionNonExclusive();
            try {
                ...
                db.delete("storage", time, null);
                Log.i(TAG, "Delete storage" +
                        " failed=" + time);
