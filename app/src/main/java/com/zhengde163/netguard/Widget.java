...
public class Widget extends AppWidgetProvider {
    ...
    private static final String INTENT_ON = "com.zhengde163.netguard.APPWIDGET_ON";
    private static final String INTENT_OFF = "com.zhengde163.netguard.APPWIDGET_OFF";
